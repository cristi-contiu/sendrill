...
define('SW_MANDRILL_WEBHOOK_URL',  '');   // the webhook URL EXACTLY as entered in Mandrill (including query parameters)
define('SW_MANDRILL_WEBHOOK_KEY',  '');   // the webhook key given by Mandrill
